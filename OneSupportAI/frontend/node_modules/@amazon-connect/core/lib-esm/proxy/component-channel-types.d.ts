import type { ChildConnectionEnabledDownstreamMessage, ChildConnectionEnabledUpstreamMessage } from "../messaging/child-connection-messages";
/**
 ...
 */
export type ComponentChannelDownstreamSender = (message: ChildConnectionEnabledDownstreamMessage) => void;
/**
 ...
 * Only applicable to component channels, not iframe channels.
 */
export type ComponentChannelUpstreamHandlerSetter = (handler: (message: ChildConnectionEnabledUpstreamMessage) => void) => void;
//# sourceMappingURL=component-channel-types.d.ts.map