...
exports.SubscriptionHandlerRelay = void 0;
...
class SubscriptionHandlerRelay {
    ...
    getProxy() {
        if (!this.proxy) {
            ...
            this.proxy = (0, proxy_1.createModuleProxy)(proxy, this.namespace);
        }
        return this.proxy;
    }
}
exports.SubscriptionHandlerRelay = SubscriptionHandlerRelay;
