...
class Proxy {
    constructor(provider) {
        ...
        this.requestManager = new request_1.RequestManager(provider);
        this.status = new proxy_connection_1.ProxyConnectionStatusManager(provider);
        this.errorService = new error_1.ErrorService(provider);
        this.upstreamMessageQueue = [];
        this.connectionEstablished = false;
        this.isInitialized = false;
        this.subscriptions = new subscription_1.SubscriptionManager();
        this.connectionId = null;
        this.channelManager = new channel_manager_1.ChannelManager(provider, this.sendOrQueueMessageToSubject.bind(this));
        this.healthCheck = new health_check_1.HealthCheckManager({
            provider,
    ...
    request(namespace, command, data, origin) {
        const msg = (0, request_1.createRequestMessage)(namespace, command, data, origin !== null && origin !== void 0 ? origin : this.getUpstreamMessageOrigin());
    ...
    log(logData) {
        const logMsg = (0, logging_1.createLogMessage)(logData, this.addContextToLogger(), this.getUpstreamMessageOrigin());
    ...
    sendMetric({ metricData, time, namespace }) {
        const metricMessage = (0, metric_1.createMetricMessage)({
            metricData,
            time,
            namespace,
